...
class MovieCardBigUi extends React.Component {

    state = { isStartVideoPlaying: false }
    ...
    render() {
        ...
        return(
            <>
                ...
                <section className={`movie-card ${isFull ? 'movie-card--full': null}`} style={{backgroundColor: film.background_color}}>
                            ...
                            <div className="movie-card__info">
                                ...
                                <div className="movie-card__desc">
                                    ...
                                    <div className="movie-card__buttons">
                                        ...
                                        <button onClick={() => favoriteHandler(film.id)} className="btn btn--play movie-card__button">
                                            <svg viewBox="0 0 19 19" width="19" height="19">
